"""
FlowAI — Visual workflow builder for AI agent pipelines
...
class Router:
    """Cost- and latency-aware model router for FlowAI."""
...
if __name__ == "__main__":
    import argparse
    p = argparse.ArgumentParser(description="FlowAI: Visual workflow builder for AI agent pipelines")
